...
select b.ROLE_CODE, b.ROLE_NAME, b.IS_VALID, 'D' as OBTAIN_TYPE, b.ROLE_DESC, b.CREATE_DATE, b.UPDATE_DATE ,a.USER_CODE
...
union
  select b.ROLE_CODE, b.ROLE_NAME, b.IS_VALID, 'I' as OBTAIN_TYPE, b.ROLE_DESC, b.CREATE_DATE, b.UPDATE_DATE ,c.USER_CODE
