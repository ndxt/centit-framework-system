...
public class UserSettingController extends BaseController {
    ...
    @RecordOperationLog(content = "操作IP地址:{loginIp},用户{userInfo.userName}更新用户设置参数")
...
//            userSetting.setUserCode(WebOptUtils.getLoginUser().getUserCode());
    ...
    @RecordOperationLog(content = "操作IP地址:{loginIp},用户{userInfo.userName}更新当前用户设置参数")
    ...
    @RecordOperationLog(content = "操作IP地址:{loginIp},用户{userInfo.userName}删除用户设置参数")
