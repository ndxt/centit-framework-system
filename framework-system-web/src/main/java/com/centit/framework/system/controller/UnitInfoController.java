...
public class UnitInfoController extends BaseController {
    ...
    @RecordOperationLog(content = "操作IP地址:{loginIp},用户{userInfo.userName}删除机构")
...
//                "删除机构"+unitInfo.getUnitName(), unitInfo);
    ...
    @RecordOperationLog(content = "操作IP地址:{loginIp},用户{userInfo.userName}新增机构")
...
//                OperationLog.P_OPT_LOG_METHOD_C,  "新增机构" , unitInfo);
    ...
    @RecordOperationLog(content = "操作IP地址:{loginIp},用户{userInfo.userName}更新机构")
...
//                "更新机构信息", unitInfo, oldValue);
    ...
    @RecordOperationLog(content = "操作IP地址:{loginIp},用户{userInfo.userName}更新机构状态")
...
//        OperationLogCenter.log(request,optId,unitCode, OperationLog.P_OPT_LOG_METHOD_U,  optContent);
   ...
   */
    ...
    @RecordOperationLog(content = "操作IP地址:{loginIp},用户{userInfo.userName}更新机构权限")
