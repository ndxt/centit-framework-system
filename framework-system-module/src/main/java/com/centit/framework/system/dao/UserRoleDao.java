...
public class UserRoleDao extends BaseDaoImpl<UserRole, UserRoleId> {
    ...
    public Map<String, String> getFilterField() {
        ...
        filterField.put("topUnit", "ROLE_CODE in (select ro.ROLE_CODE from f_roleinfo ro where ROLE_TYPE='P' or (ro.ROLE_TYPE='D' and ro.UNIT_CODE = :topUnit))");
        //filterField.put("topUnit", "ROLE_CODE in (select ro.ROLE_CODE from f_roleinfo ro where ROLE_TYPE = 'G' or ROLE_TYPE='P' or (ro.ROLE_TYPE='D' and ro.UNIT_CODE = :topUnit))");
