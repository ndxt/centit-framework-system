...
import com.centit.framework.system.security.DefaultCentitUserDetails;
...
public class TestUserDetails {
    ...
    public void testUserDetailJson() throws Exception {
        ...
        DefaultCentitUserDetails userDetails =
            JSON.parseObject(userJson, DefaultCentitUserDetails.class);
